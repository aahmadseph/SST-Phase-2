...
export default function seoBuyPage(options) {
    ...
    const apiEndpoint = `/seo-service/util/buyPages/${seoName}/seoName?loc=${options.language?.toLowerCase()}-${options.country}`;
