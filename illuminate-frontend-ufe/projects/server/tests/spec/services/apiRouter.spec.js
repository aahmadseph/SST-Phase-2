/*describe('apiRouter.mjs', () => {
    ...
    beforeAll((done) => {
        ...
        process.env.API_ROUTER_SERVER_PORT = 13000;
        process.env.API_ROUTER_SERVER_NAME = 'localhost';
        ...
        cluster.setupMaster({
            exec: `${baseDir}/server/services/apiRouter.mjs`,
            args: ['--use', 'https']
        });
    ...
    it('getStatus testing', (done) => {
        ...
        const host = process.env.API_ROUTER_SERVER_NAME,
            port = process.env.API_ROUTER_SERVER_PORT,
