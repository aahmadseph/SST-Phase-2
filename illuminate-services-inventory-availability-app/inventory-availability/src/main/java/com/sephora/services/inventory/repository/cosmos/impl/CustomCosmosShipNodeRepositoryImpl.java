...
import com.sephora.services.inventory.repository.cosmos.CustomCosmosShipNodeRepository;
...
public class CustomCosmosShipNodeRepositoryImpl extends QuerySupportedCosmosRepository<ShipNode, String>
    ...
    public CustomCosmosShipNodeRepositoryImpl(@Autowired(required = false) CustomCosmosTemplate cosmosTemplate) {
