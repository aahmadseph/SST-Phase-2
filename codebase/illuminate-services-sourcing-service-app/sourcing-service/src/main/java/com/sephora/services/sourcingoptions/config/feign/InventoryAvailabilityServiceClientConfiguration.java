...
@Configuration
@ConfigurationProperties(prefix = "sourcing.options.feign.inventoryavailability")
@RunTimeConfiguration
public class InventoryAvailabilityServiceClientConfiguration {
    ...
    @Bean
    @RefreshScope
    public InventoryAvailabilityServiceClient inventoryServiceClient() {
        ...
        return Feign.builder()
                ...
                .options(options)
                .target(InventoryAvailabilityServiceClient.class, serviceUrl);
    }
